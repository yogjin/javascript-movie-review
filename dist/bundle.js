...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ MovieCard)\n/* harmony export */ });\n/* harmony import */ var _assets_star_filled__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/star_filled */ \"./src/assets/star_filled.png\");\n\nconst IMAGE_BASE = 'https://image.tmdb.org/t/p/original';\nclass MovieCard {\n    constructor($parent, movie) {\n        this.$parent = $parent;\n        this.movie = movie;\n    }\n    template() {\n        const { poster_path, title, vote_average } = this.movie;\n        return `\n      <li>\n        <a href=\"#\">\n          <div class=\"item-card\">\n            <img\n              class=\"item-thumbnail\"\n              src=\"${IMAGE_BASE}${poster_path}\"\n              loading=\"lazy\"\n              alt=\"${title}\"\n            />\n            <p class=\"item-title\">${title}</p>\n            <p class=\"item-score\"><img src=\"${_assets_star_filled__WEBPACK_IMPORTED_MODULE_0__}\" alt=\"별점\" /> ${vote_average}</p>\n          </div>\n        </a>\n      </li>\n    `;\n    }\n    render() {\n        this.$parent.insertAdjacentHTML('beforeend', this.template());\n    }\n}\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/components/MovieCard.js?");
